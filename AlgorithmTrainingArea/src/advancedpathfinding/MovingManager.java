...
public class MovingManager {
    ...
    /**
     * Сравнивает исполняемые приоритеты для 2-х юнитов. Возвращает true, если
     * значение поля priority ключа первого параметра больше чем у второго. В
     * случае равенства сравниваются id параметров, если у u1 поле id больше, то
     * возвращается true. Также возвращается true, если один из параметров null
     *
     * @param u1 Unit
     * @param u2 Unit
     * @return boolean
